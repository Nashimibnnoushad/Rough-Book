...
@Component({
  selector: 'app-yearlybook',
  templateUrl: './yearlybook.page.html',
  styleUrls: ['./yearlybook.page.scss'],
})
export class YearlybookPage implements OnInit {
 ...
 malayalam = ['വരവ്', 'ചിലവ്']
  ...
  constructor(private popover: PopoverController, private ref: ChangeDetectorRef, private variable:VariablesService,
    ...
    if (this.transactionlist != null) {
      this.temptransactionlist = this.transactionlist.filter(x => x.Date.slice(6) == tempdate.slice(6))
